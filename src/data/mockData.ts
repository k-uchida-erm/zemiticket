...
export const mockActiveGroups: { parent: ParentTask; children: SubTask[] }[] = [
	{
		parent: {
			...
			description:
				'プロトコルの最終版を策定し、全員に共有。装置設定とサンプル処理の標準化を含む。',
	...
	},
	{
		parent: {
			...
			description:
				'レビューコメントを反映し、構成を簡潔に整理する。引用の最新化も行う。',
...
export const mockSubmittingTickets: Array<
	ParentTask & { children?: SubTask[] }
> = [
	{
		id: '101',
		title: '進捗レポート(5月第2週)',
	...
	},
	{
		...
		reviewComments: [{ author: '教授', text: '倫理手続きの追記が必要。' }],
		epic: '倫理・手順',
		children: [
			{
				id: '1021',
...
export const mockOthersActiveParents: Array<
	ParentTask & { children: SubTask[] }
> = [
	{
		id: '201',
	...
	parents: [
		{
			...
			parent: {
				...
				due: '2025-05-30',
				progressPercentage: 40,
				description: 'プロトコルの最終版を策定し、全員に共有。',
				slug: 'protocol-v2-finalize',
				status: 'in_progress',
				priority: 'high',
				commentsCount: 3,
		...
		},
		{
			...
			parent: {
				...
				due: '2025-06-05',
				progressPercentage: 60,
				description: 'レビューコメントを反映し、構成を簡潔に整理する。',
				slug: 'paper-draft-revise-intro-related',
				status: 'review',
				priority: 'medium',
				commentsCount: 4,
