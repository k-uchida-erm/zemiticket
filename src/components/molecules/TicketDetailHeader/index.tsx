			...
			<div className='absolute top-4 right-0 flex items-center gap-2'>
				...
				{dirty && (
					<>
						...
						<button
							onClick={onCancel}
							className='px-3 py-1.5 text-[12px] rounded border border-neutral-300 text-neutral-700 bg-white'
						>
							Cancel
						</button>
					</>
				...
				<button
					...
					className='h-7 w-7 inline-flex items-center justify-center rounded hover:bg-neutral-50 text-neutral-600'
