...
interface OthersActiveSectionProps {
	othersGrouped: {
		user: string;
		tickets: Array<ParentTask & { children?: SubTask[] }>;
	}[];
}

export default function OthersActiveSection({
	othersGrouped,
}: OthersActiveSectionProps) {
	return (
		<section>
			<SectionTitle variant='amber' icon={<IconUser />}>
				Others Active Tickets
			</SectionTitle>
