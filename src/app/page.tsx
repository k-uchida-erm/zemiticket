...
export default function Home() {
  const activeGroups: { parent: ParentTask; children: SubTask[] }[] = [
    {
      parent: {
        id: 1,
        title: '実験プロトコルv2の確定',
      ...
      children: [
        ...
        { id: 13, title: '検証データの取得(week2)', user: '田中 太郎', due: '2025-05-22', done: false, description: '10サンプル x 3回測定', slug: 'collect-week2-data', status: 'todo', priority: 'high', commentsCount: 0, updatedAt: '5h ago', estimateHours: 4, todos: [
  ...
  const submittingTickets: Array<ParentTask & { children?: SubTask[] }> = [
    {
      ...
      epic: 'レポート',
      children: [
        { id: 1011, title: '図2の注釈を改善', user: '田中 太郎', due: '2025-05-13', done: false, description: '注釈のラベルと位置見直し', slug: 'improve-fig2-legend', status: 'in_progress', priority: 'medium', commentsCount: 0, updatedAt: '1h ago', estimateHours: 1.5, todos: [
        ...
        { id: 1012, title: '定量指標の追記', user: '田中 太郎', due: '2025-05-14', done: false, description: '精度/再現率/F1を追加', slug: 'add-metrics', status: 'todo', priority: 'high', commentsCount: 0, updatedAt: '30m ago', estimateHours: 2, todos: [
    ...
    },
    {
      ...
      epic: '倫理・手順',
      children: [
        { id: 1021, title: '倫理手続きの章追加', user: '佐藤 花子', due: '2025-05-17', done: false, description: 'IRB番号と手順追記', slug: 'irb-section-add', status: 'in_progress', priority: 'urgent', commentsCount: 1, updatedAt: '2h ago', estimateHours: 1.5, todos: [
        ...
        { id: 1022, title: '被験者条件の再定義', user: '佐藤 花子', due: '2025-05-18', done: false, description: '年齢/性別/健康状態', slug: 'redefine-criteria', status: 'todo', priority: 'high', commentsCount: 0, updatedAt: '1h ago', estimateHours: 1.2, todos: [
  ...
  const othersActiveParents: Array<ParentTask & { children: SubTask[] }> = [
    {
      ...
      epic: '評価実験',
      children: [
        { id: 2011, title: '募集フォームの作成', user: '山本 蓮', due: '2025-05-18', done: true, description: 'Google Formで作成', slug: 'recruit-form-build', status: 'done', priority: 'low', commentsCount: 0, updatedAt: '3d ago', estimateHours: 1,
          todos: [
            { id: 20111, title: '設問設計', done: true, estimateHours: 0.3 },
            { id: 20112, title: '同意文面記載', done: true, estimateHours: 0.4 },
          ]
        },
        { id: 2012, title: '募集メール文面の草案', user: '山本 蓮', due: '2025-05-19', done: false, description: '対象/謝礼/日程/同意', slug: 'recruit-mail-draft', status: 'in_progress', priority: 'medium', commentsCount: 1, updatedAt: '1d ago', estimateHours: 2,
          todos: [
        ...
        { id: 2013, title: '教授レビュー反映', user: '山本 蓮', due: '2025-05-21', done: false, description: '文面のトーン調整', slug: 'apply-prof-review', status: 'todo', priority: 'low', commentsCount: 0, updatedAt: '10h ago', estimateHours: 1,
          todos: [
    ...
    },
    {
      ...
      epic: 'データ基盤',
      children: [
        { id: 2021, title: '現状データの品質評価', user: '山田 純', due: '2025-05-22', done: false, description: '欠損/外れ値の分布確認', slug: 'current-quality-audit', status: 'in_progress', priority: 'medium', commentsCount: 0, updatedAt: '6h ago', estimateHours: 3,
          todos: [
        ...
        { id: 2022, title: '補完戦略の比較表作成', user: '山田 純', due: '2025-05-25', done: false, description: '平均/中央値/kNN/回帰', slug: 'imputation-comparison', status: 'todo', priority: 'medium', commentsCount: 0, updatedAt: '6h ago', estimateHours: 2,
          todos: [
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
      ...
      <div className="lg:col-span-2 lg:border-l lg:border-neutral-200 lg:pl-6">
