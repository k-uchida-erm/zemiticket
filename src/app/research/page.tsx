	...
	return (
		<div className='px-6 space-y-6'>
			...
			<nav className='flex items-center gap-6 pb-4'>
				...
				<Link
					href='/epic'
					className='text-sm font-medium text-neutral-600 hover:text-neutral-800 pb-2 hover:border-b-2 hover:border-neutral-300 transition-all'
				>
					エピック管理
				</Link>
			...
			{isEditing && (
				<div className='flex items-center justify-end gap-2'>
					<button
						...
						className='px-3 py-1.5 text-[12px] rounded border border-neutral-300 bg-white text-neutral-700'
					>
						キャンセル
					</button>
					<button
						onClick={handleSave}
						className='px-3 py-1.5 text-[12px] rounded bg-[#00b393] text-white'
					>
						保存
					</button>
				</div>
